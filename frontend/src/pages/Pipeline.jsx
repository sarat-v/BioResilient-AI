...
const ALL_STEPS = [
  ...
  { id: 'step4b',  label: 'Pfam domain annotation + AlphaMissense',       phase: 1 },
  { id: 'step4c',  label: 'ESM-1v variant effect scoring',                phase: 1 },
  { id: 'step4d',  label: 'Variant direction inference (GoF / LoF)',       phase: 1 },
  { id: 'step5',   label: 'Build phylogenetic tree (IQ-TREE)',             phase: 1 },
  { id: 'step6',   label: 'Evolutionary selection — MEME',                phase: 1 },
  { id: 'step6b',  label: 'Selection — FEL + BUSTED',                     phase: 1 },
  { id: 'step6c',  label: 'Selection — RELAX branch acceleration',        phase: 1 },
  { id: 'step7',   label: 'Score convergence & conservation',             phase: 1 },
  { id: 'step7b',  label: 'True convergent amino acid detection',         phase: 1 },
  { id: 'step8',   label: 'Expression analysis (GEO / DESeq2)',           phase: 1 },
  { id: 'step8b',  label: 'Bgee cross-species expression supplement',     phase: 1 },
  { id: 'step9',   label: 'Compute Phase 1 composite scores',             phase: 1 },
  { id: 'step10',  label: 'API ready',                                    phase: 1 },
  { id: 'step10b', label: 'Regulatory divergence (AlphaGenome)',          phase: 2 },
  { id: 'step11',  label: 'Disease annotation (OpenTargets / GWAS)',      phase: 2 },
  { id: 'step11b', label: 'Rare protective variant mapping (gnomAD)',     phase: 2 },
  { id: 'step11c', label: 'Literature validation (PubMed)',               phase: 2 },
  { id: 'step11d', label: 'Pathway convergence enrichment',               phase: 2 },
  { id: 'step12',  label: 'Druggability — AlphaFold + fpocket',          phase: 2 },
  { id: 'step12b', label: 'Druggability — P2Rank ML pockets',            phase: 2 },
  { id: 'step13',  label: 'Gene therapy feasibility (AAV / CRISPR)',     phase: 2 },
  { id: 'step14',  label: 'Safety pre-screen (PheWAS / STRING)',         phase: 2 },
  { id: 'step14b', label: 'Safety — DepMap essentiality + GTEx breadth', phase: 2 },
  { id: 'step15',  label: 'Final re-score with Phase 2 weights',         phase: 2 },
