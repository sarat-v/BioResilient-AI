...
def generate_dossier(gene_id: str, phenotype: str = "") -> Optional[str]:
    ...
    lines += [
        "---",
        "",
        "## 8. Pipeline Boundary & Next Steps",
        "",
        "This dossier is the **final output of the BioResilient computational pipeline** "
        "(Steps 1–18). All evidence presented is derived from publicly available databases "
        "and computational predictions. No wet-lab data has been generated.",
        "",
        "**To advance this target, the experimental programme should provide:**",
        "",
        "- Binding confirmation (thermal shift, SPR, or ITC) against the identified pocket",
        "- Cellular phenotype confirmation (knockdown / overexpression in disease-relevant model)",
        "- In-vivo proof-of-concept in the recommended model organism",
        "- ADMET profiling of any small-molecule hits arising from biochemical screens",
        "",
        "> **Note:** Virtual screening, ADMET prediction, and lead optimisation (Steps 19–25) "
        "are a separate downstream product requiring wet-lab validation data as input. "
        "Contact the BioResilient team to initiate the Lead Discovery programme.",
        "",
        "---",
        "",
        f"*Generated by BioResilient Pipeline v2 | Gene: {gene_id} | Phenotype: {phenotype_label} | "
        f"Computational dossier — wet-lab validation required before clinical progression*",
    ]
